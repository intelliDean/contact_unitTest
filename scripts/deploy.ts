...
//
// async function main() {
//     const deanNFT = await ethers.deployContract("EventNft");
//     await deanNFT.waitForDeployment();
//
//     const event = await ethers.deployContract("NftGatedEvent", [deanNFT.target]);
//     await event.waitForDeployment();
//
//     console.log(`Contract: DeanNFT deployed to ${deanNFT.target}`);
//
//     console.log(`Contract: NftGatedEvent deployed to ${event.target}`);
//
//     console.log(`${await event.eventNft()} is the same with ${deanNFT.target}`)
//
// }
//
